...
fun <T: Any> findGeneratedModule(moduleClass: KClass<T>): audio.rabid.kaddi.Module {
    ...
    return targetClass.newInstance() as audio.rabid.kaddi.Module
}

inline fun <reified T: Any> generatedModule(): audio.rabid.kaddi.Module = findGeneratedModule(T::class)
